...
export type FSelectProps<T = unknown> = PropsWithDivRef &
	PropsWithCustomStyle & {
		/** Options data. */
		options: T[];
		 ...
		 */
		dropdownWrapperClassName?: PropsWithCustomStyle["className"];
		 ...
		 */
		dropdownWrapperStyle?: PropsWithCustomStyle["style"];
	};
