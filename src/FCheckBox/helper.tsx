...
export const handleFCheckBox = (props: FCheckBoxProps) => {
	const { type, checked, fillColor, iconColor, borderColor, strokeWidth } =
		props;
			...
			return checked ? (
				<>
					<path
						...
						fill={fillColor ?? mainThemeColor}
					/>
					<path
						d="M17.3896 8L9.3976 16L7 13.6024"
						stroke={iconColor ?? whiteColor}
				...
				<>
					<path
						...
						stroke={borderColor ?? bgLightColor}
