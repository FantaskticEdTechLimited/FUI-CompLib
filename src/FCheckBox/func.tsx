			...
			return props.checked ? (
				<>
					...
					<path
						...
						stroke={props.iconColor ?? FColorTypes.FPrimaryColors.WHITE}
				...
				<>
					<path
						...
						fill={props.fillColor ?? FColorTypes.FPrimaryColors.WHITE}
						stroke={props.borderColor ?? FColorTypes.FPrimaryColors.BG_LIGHT}
					...
					<path
						d="M17.3896 8L9.3976 16L7 13.6024"
						stroke={props.iconColor ?? FColorTypes.FPrimaryColors.BG_LIGHT}
						strokeWidth={props.strokeWidth ?? "1.6"}
						strokeLinecap="round"
						strokeLinejoin="round"
					/>
