...
export const handleFRadioButton = (props: FRadioButtonProps) => {
	...
	return props.checked ? (
		<>
			<path
				...
				stroke={props.color ?? mainThemeColor}
			...
			<path
				...
				fill={props.color ?? mainThemeColor}
			/>
		</>
	) : (
		<path
			...
			fill={props.fillColor ?? whiteColor}
			stroke={props.color ?? FReturnColor({ color: "BG Light" })}
